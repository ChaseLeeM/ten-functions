...
//3. Function returns opposite value of any input.

function not(input){
    return !input;
}

//4. Function returns numerical or numerical string value plus one.

function addOne(input){
    return parseFloat(input) + 1;
}

//5. Is even function. Define a function named isEven that takes in a single input. If the input is an even number
...
//6. Define a function named isIdentical that takes in two input arguments. If each input is equal both in data type
...
//8. Define a function named or that takes in two input arguments. The output returned should be the result of an or
...
//9. Define a function named and that takes in two input arguments and returns the result of a logical and operation
// of both inputs.
